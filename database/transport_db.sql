...
-- Table pour stocker l'historique des trajets réels
CREATE TABLE IF NOT EXISTS trip_logs (
    ...
    actual_duration_seconds INTEGER, -- Temps réel mis
...
CREATE INDEX idx_trip_logs_stations ON trip_logs(from_station_id, to_station_id);
CREATE INDEX idx_trip_logs_time ON trip_logs(departure_time);